...
class Personne{
  ...
  bool statuspaiment;
  Personne({required this.fin_abonnement,required this.statuspaiment,required this.id,required this.uid, required this.image_profile, required this.Numero_tel, required this.Nom, required this.Prenom, required this.Age, required this.Sex, required this.Mail,required this.type_user,});
