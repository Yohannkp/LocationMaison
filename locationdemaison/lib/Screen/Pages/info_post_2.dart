...
class info_post_2 extends StatefulWidget {
  const info_post_2({Key? key}) : super(key: key);

  @override
  State<info_post_2> createState() => _info_post_2State();
}

class _info_post_2State extends State<info_post_2> {
