...
class info_post_1 extends StatefulWidget {
  const info_post_1({Key? key}) : super(key: key);

  @override
  State<info_post_1> createState() => _info_post_1State();
}

class _info_post_1State extends State<info_post_1> {
